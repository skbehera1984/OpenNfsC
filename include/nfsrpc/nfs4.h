...
struct __attribute__((packed)) nfstime4 {
	int64_t seconds;
	uint32_t nseconds;
};
...
struct __attribute__((packed)) settime4 {
	time_how4 set_it;
	union {
		nfstime4 time;
	} settime4_u;
...
struct __attribute__((packed)) fsid4 {
	uint64_t major;
	uint64_t minor;
};
typedef struct fsid4 fsid4;

struct __attribute__((packed)) fs_location4 {
...
struct __attribute__((packed)) fs_locations4 {
	pathname4 fs_root;
	struct __attribute__((packed)) {
		u_int locations_len;
...
struct __attribute__((packed)) nfsace4 {
	acetype4 type;
	aceflag4 flag;
...
struct __attribute__((packed)) specdata4 {
	uint32_t specdata1;
	uint32_t specdata2;
};
...
struct __attribute__((packed)) fattr4 {
	bitmap4 attrmask;
	attrlist4 attr_vals;
};
typedef struct fattr4 fattr4;

struct __attribute__((packed)) change_info4 {
	bool_t atomic;
	changeid4 before;
	changeid4 after;
};
...
struct __attribute__((packed)) clientaddr4 {
	char *r_netid;
	char *r_addr;
};
typedef struct clientaddr4 clientaddr4;

struct __attribute__((packed)) cb_client4 {
	uint32_t cb_program;
	clientaddr4 cb_location;
};
typedef struct cb_client4 cb_client4;

struct __attribute__((packed)) stateid4 {
	uint32_t seqid;
	char other[12];
};
typedef struct stateid4 stateid4;

struct __attribute__((packed)) nfs_client_id4 {
	verifier4 verifier;
	struct __attribute__((packed)) {
		u_int id_len;
		char *id_val;
...
struct __attribute__((packed)) open_owner4 {
	clientid4 clientid;
	struct __attribute__((packed)) {
		u_int owner_len;
		char *owner_val;
...
struct __attribute__((packed)) lock_owner4 {
	clientid4 clientid;
	struct __attribute__((packed)) {
		u_int owner_len;
		char *owner_val;
...
struct __attribute__((packed)) ACCESS4args {
	uint32_t access;
};
typedef struct ACCESS4args ACCESS4args;

struct __attribute__((packed)) ACCESS4resok {
	uint32_t supported;
	uint32_t access;
};
typedef struct ACCESS4resok ACCESS4resok;

struct __attribute__((packed)) ACCESS4res {
	nfsstat4 status;
	union {
		ACCESS4resok resok4;
	} ACCESS4res_u;
...
struct __attribute__((packed)) CLOSE4args {
	seqid4 seqid;
	stateid4 open_stateid;
};
typedef struct CLOSE4args CLOSE4args;

struct __attribute__((packed)) CLOSE4res {
	nfsstat4 status;
	union {
		stateid4 open_stateid;
	} CLOSE4res_u;
...
struct __attribute__((packed)) COMMIT4args {
	offset4 offset;
	count4 count;
};
typedef struct COMMIT4args COMMIT4args;

struct __attribute__((packed)) COMMIT4resok {
	verifier4 writeverf;
};
typedef struct COMMIT4resok COMMIT4resok;

struct __attribute__((packed)) COMMIT4res {
	nfsstat4 status;
	union {
		COMMIT4resok resok4;
	} COMMIT4res_u;
...
struct __attribute__((packed)) createtype4 {
	nfs_ftype4 type;
	union {
		linktext4 linkdata;
		specdata4 devdata;
...
struct __attribute__((packed)) CREATE4args {
	createtype4 objtype;
	component4 objname;
	fattr4 createattrs;
};
...
struct __attribute__((packed)) CREATE4resok {
	change_info4 cinfo;
	bitmap4 attrset;
};
typedef struct CREATE4resok CREATE4resok;

struct __attribute__((packed)) CREATE4res {
	nfsstat4 status;
	union {
		CREATE4resok resok4;
	} CREATE4res_u;
...
struct __attribute__((packed)) DELEGPURGE4args {
	clientid4 clientid;
};
typedef struct DELEGPURGE4args DELEGPURGE4args;

struct __attribute__((packed)) DELEGPURGE4res {
	nfsstat4 status;
};
typedef struct DELEGPURGE4res DELEGPURGE4res;

struct __attribute__((packed)) DELEGRETURN4args {
	stateid4 deleg_stateid;
};
typedef struct DELEGRETURN4args DELEGRETURN4args;

struct __attribute__((packed)) DELEGRETURN4res {
	nfsstat4 status;
};
typedef struct DELEGRETURN4res DELEGRETURN4res;

struct __attribute__((packed)) GETATTR4args {
	bitmap4 attr_request;
};
typedef struct GETATTR4args GETATTR4args;

struct __attribute__((packed)) GETATTR4resok {
	fattr4 obj_attributes;
};
typedef struct GETATTR4resok GETATTR4resok;

struct __attribute__((packed)) GETATTR4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) GETFH4resok {
	nfs_fh4 object;
};
typedef struct GETFH4resok GETFH4resok;

struct __attribute__((packed)) GETFH4res {
	nfsstat4 status;
	union {
		GETFH4resok resok4;
	} GETFH4res_u;
...
struct __attribute__((packed)) LINK4args {
	component4 newname;
};
typedef struct LINK4args LINK4args;

struct __attribute__((packed)) LINK4resok {
	change_info4 cinfo;
};
typedef struct LINK4resok LINK4resok;

struct __attribute__((packed)) LINK4res {
	nfsstat4 status;
	union {
		LINK4resok resok4;
	} LINK4res_u;
...
struct __attribute__((packed)) open_to_lock_owner4 {
	seqid4 open_seqid;
	stateid4 open_stateid;
	seqid4 lock_seqid;
...
struct __attribute__((packed)) exist_lock_owner4 {
	stateid4 lock_stateid;
	seqid4 lock_seqid;
};
typedef struct exist_lock_owner4 exist_lock_owner4;

struct __attribute__((packed)) locker4 {
...
struct __attribute__((packed)) LOCK4args {
...
struct __attribute__((packed)) LOCK4denied {
	offset4 offset;
	length4 length;
	nfs_lock_type4 locktype;
	lock_owner4 owner;
...
struct __attribute__((packed)) LOCK4resok {
	stateid4 lock_stateid;
};
typedef struct LOCK4resok LOCK4resok;

struct __attribute__((packed)) LOCK4res {
	nfsstat4 status;
	union {
		LOCK4resok resok4;
		LOCK4denied denied;
...
struct __attribute__((packed)) LOCKT4args {
	nfs_lock_type4 locktype;
	offset4 offset;
	length4 length;
	lock_owner4 owner;
...
struct __attribute__((packed)) LOCKT4res {
	nfsstat4 status;
	union {
		LOCK4denied denied;
	} LOCKT4res_u;
...
struct __attribute__((packed)) LOCKU4args {
	nfs_lock_type4 locktype;
	seqid4 seqid;
	stateid4 lock_stateid;
	offset4 offset;
...
struct __attribute__((packed)) LOCKU4res {
	nfsstat4 status;
	union {
		stateid4 lock_stateid;
	} LOCKU4res_u;
...
struct __attribute__((packed)) LOOKUP4args {
	component4 objname;
};
typedef struct LOOKUP4args LOOKUP4args;

struct __attribute__((packed)) LOOKUP4res {
	nfsstat4 status;
};
typedef struct LOOKUP4res LOOKUP4res;

struct __attribute__((packed)) LOOKUPP4res {
	nfsstat4 status;
};
typedef struct LOOKUPP4res LOOKUPP4res;

struct __attribute__((packed)) NVERIFY4args {
	fattr4 obj_attributes;
};
typedef struct NVERIFY4args NVERIFY4args;

struct __attribute__((packed)) NVERIFY4res {
	nfsstat4 status;
};
...
struct __attribute__((packed)) createhow4 {
	createmode4 mode;
	union {
		fattr4 createattrs;
...
struct __attribute__((packed)) openflag4 {
	opentype4 opentype;
	union {
		createhow4 how;
	} openflag4_u;
...
struct __attribute__((packed)) nfs_modified_limit4 {
	uint32_t num_blocks;
	uint32_t bytes_per_block;
};
typedef struct nfs_modified_limit4 nfs_modified_limit4;

struct __attribute__((packed)) nfs_space_limit4 {
	limit_by4 limitby;
	union {
		uint64_t filesize;
...
struct __attribute__((packed)) open_claim_delegate_cur4 {
	stateid4 delegate_stateid;
	component4 file;
};
typedef struct open_claim_delegate_cur4 open_claim_delegate_cur4;

struct __attribute__((packed)) open_claim4 {
...
struct __attribute__((packed)) OPEN4args {
	seqid4 seqid;
...
struct __attribute__((packed)) open_read_delegation4 {
	stateid4 stateid;
	bool_t recall;
	nfsace4 permissions;
};
...
struct __attribute__((packed)) open_write_delegation4 {
	stateid4 stateid;
	bool_t recall;
...
struct __attribute__((packed)) open_delegation4 {
...
struct __attribute__((packed)) OPEN4resok {
	stateid4 stateid;
	change_info4 cinfo;
	uint32_t rflags;
	bitmap4 attrset;
...
struct __attribute__((packed)) OPEN4res {
	nfsstat4 status;
	union {
		OPEN4resok resok4;
	} OPEN4res_u;
...
struct __attribute__((packed)) OPENATTR4args {
	bool_t createdir;
};
typedef struct OPENATTR4args OPENATTR4args;

struct __attribute__((packed)) OPENATTR4res {
	nfsstat4 status;
};
typedef struct OPENATTR4res OPENATTR4res;

struct __attribute__((packed)) OPEN_CONFIRM4args {
	stateid4 open_stateid;
	seqid4 seqid;
};
typedef struct OPEN_CONFIRM4args OPEN_CONFIRM4args;

struct __attribute__((packed)) OPEN_CONFIRM4resok {
	stateid4 open_stateid;
};
typedef struct OPEN_CONFIRM4resok OPEN_CONFIRM4resok;

struct __attribute__((packed)) OPEN_CONFIRM4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) OPEN_DOWNGRADE4args {
	stateid4 open_stateid;
	seqid4 seqid;
	uint32_t share_access;
	uint32_t share_deny;
...
struct __attribute__((packed)) OPEN_DOWNGRADE4resok {
	stateid4 open_stateid;
};
typedef struct OPEN_DOWNGRADE4resok OPEN_DOWNGRADE4resok;

struct __attribute__((packed)) OPEN_DOWNGRADE4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) PUTFH4args {
	nfs_fh4 object;
};
typedef struct PUTFH4args PUTFH4args;

struct __attribute__((packed)) PUTFH4res {
	nfsstat4 status;
};
typedef struct PUTFH4res PUTFH4res;

struct __attribute__((packed)) PUTPUBFH4res {
	nfsstat4 status;
};
typedef struct PUTPUBFH4res PUTPUBFH4res;

struct __attribute__((packed)) PUTROOTFH4res {
	nfsstat4 status;
};
typedef struct PUTROOTFH4res PUTROOTFH4res;

struct __attribute__((packed)) READ4args {
	stateid4 stateid;
	offset4 offset;
	count4 count;
};
...
struct __attribute__((packed)) READ4resok {
	bool_t eof;
	struct __attribute__((packed)) {
		u_int data_len;
		char *data_val;
...
struct __attribute__((packed)) READ4res {
	nfsstat4 status;
	union {
		READ4resok resok4;
	} READ4res_u;
...
struct __attribute__((packed)) READDIR4args {
	nfs_cookie4 cookie;
...
struct __attribute__((packed)) entry4 {
	nfs_cookie4 cookie;
	component4 name;
	fattr4 attrs;
...
struct __attribute__((packed)) dirlist4 {
	entry4 *entries;
	bool_t eof;
};
typedef struct dirlist4 dirlist4;

struct __attribute__((packed)) READDIR4resok {
	verifier4 cookieverf;
	dirlist4 reply;
};
typedef struct READDIR4resok READDIR4resok;

struct __attribute__((packed)) READDIR4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) READLINK4resok {
	linktext4 link;
};
typedef struct READLINK4resok READLINK4resok;

struct __attribute__((packed)) READLINK4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) REMOVE4args {
	component4 target;
};
typedef struct REMOVE4args REMOVE4args;

struct __attribute__((packed)) REMOVE4resok {
	change_info4 cinfo;
};
typedef struct REMOVE4resok REMOVE4resok;

struct __attribute__((packed)) REMOVE4res {
	nfsstat4 status;
	union {
		REMOVE4resok resok4;
	} REMOVE4res_u;
...
struct __attribute__((packed)) RENAME4args {
	component4 oldname;
	component4 newname;
};
typedef struct RENAME4args RENAME4args;

struct __attribute__((packed)) RENAME4resok {
	change_info4 source_cinfo;
	change_info4 target_cinfo;
};
typedef struct RENAME4resok RENAME4resok;

struct __attribute__((packed)) RENAME4res {
	nfsstat4 status;
	union {
		RENAME4resok resok4;
	} RENAME4res_u;
...
struct __attribute__((packed)) RENEW4args {
	clientid4 clientid;
};
typedef struct RENEW4args RENEW4args;

struct __attribute__((packed)) RENEW4res {
	nfsstat4 status;
};
typedef struct RENEW4res RENEW4res;

struct __attribute__((packed)) RESTOREFH4res {
	nfsstat4 status;
};
typedef struct RESTOREFH4res RESTOREFH4res;

struct __attribute__((packed)) SAVEFH4res {
	nfsstat4 status;
};
typedef struct SAVEFH4res SAVEFH4res;

struct __attribute__((packed)) SECINFO4args {
	component4 name;
};
...
struct __attribute__((packed)) rpcsec_gss_info {
	sec_oid4 oid;
	qop4 qop;
...
struct __attribute__((packed)) secinfo4 {
	uint32_t flavor;
	union {
...
struct __attribute__((packed)) SECINFO4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) SETATTR4args {
	stateid4 stateid;
	fattr4 obj_attributes;
};
typedef struct SETATTR4args SETATTR4args;

struct __attribute__((packed)) SETATTR4res {
	nfsstat4 status;
	bitmap4 attrsset;
};
typedef struct SETATTR4res SETATTR4res;

struct __attribute__((packed)) SETCLIENTID4args {
...
struct __attribute__((packed)) SETCLIENTID4resok {
	clientid4 clientid;
	verifier4 setclientid_confirm;
};
typedef struct SETCLIENTID4resok SETCLIENTID4resok;

struct __attribute__((packed)) SETCLIENTID4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) SETCLIENTID_CONFIRM4args {
	clientid4 clientid;
	verifier4 setclientid_confirm;
};
typedef struct SETCLIENTID_CONFIRM4args SETCLIENTID_CONFIRM4args;

struct __attribute__((packed)) SETCLIENTID_CONFIRM4res {
	nfsstat4 status;
};
typedef struct SETCLIENTID_CONFIRM4res SETCLIENTID_CONFIRM4res;

struct __attribute__((packed)) VERIFY4args {
	fattr4 obj_attributes;
};
typedef struct VERIFY4args VERIFY4args;

struct __attribute__((packed)) VERIFY4res {
	nfsstat4 status;
};
...
struct __attribute__((packed)) WRITE4args {
	stateid4 stateid;
	offset4 offset;
	stable_how4 stable;
	struct __attribute__((packed)) {
...
struct __attribute__((packed)) WRITE4resok {
	count4 count;
...
struct __attribute__((packed)) WRITE4res {
	nfsstat4 status;
	union {
		WRITE4resok resok4;
	} WRITE4res_u;
...
struct __attribute__((packed)) RELEASE_LOCKOWNER4args {
	lock_owner4 lock_owner;
};
typedef struct RELEASE_LOCKOWNER4args RELEASE_LOCKOWNER4args;

struct __attribute__((packed)) RELEASE_LOCKOWNER4res {
	nfsstat4 status;
};
typedef struct RELEASE_LOCKOWNER4res RELEASE_LOCKOWNER4res;

struct __attribute__((packed)) ILLEGAL4res {
	nfsstat4 status;
};
...
struct __attribute__((packed)) nfs_argop4 {
	nfs_opnum4 argop;
	union {
...
struct __attribute__((packed)) nfs_resop4 {
	nfs_opnum4 resop;
	union {
		ACCESS4res opaccess;
		CLOSE4res opclose;
...
struct __attribute__((packed)) COMPOUND4args {
	utf8str_cs tag;
...
struct __attribute__((packed)) COMPOUND4res {
	nfsstat4 status;
	utf8str_cs tag;
	struct __attribute__((packed)) {
		u_int resarray_len;
...
struct __attribute__((packed)) CB_GETATTR4args {
	nfs_fh4 fh;
	bitmap4 attr_request;
};
typedef struct CB_GETATTR4args CB_GETATTR4args;

struct __attribute__((packed)) CB_GETATTR4resok {
	fattr4 obj_attributes;
};
typedef struct CB_GETATTR4resok CB_GETATTR4resok;

struct __attribute__((packed)) CB_GETATTR4res {
	nfsstat4 status;
	union {
...
struct __attribute__((packed)) CB_RECALL4args {
	stateid4 stateid;
	bool_t truncate;
	nfs_fh4 fh;
};
...
struct __attribute__((packed)) CB_RECALL4res {
	nfsstat4 status;
};
typedef struct CB_RECALL4res CB_RECALL4res;

struct __attribute__((packed)) CB_ILLEGAL4res {
	nfsstat4 status;
};
...
struct __attribute__((packed)) nfs_cb_argop4 {
	u_int argop;
	union {
...
struct __attribute__((packed)) nfs_cb_resop4 {
	u_int resop;
	union {
...
struct __attribute__((packed)) CB_COMPOUND4args {
	utf8str_cs tag;
	uint32_t minorversion;
	uint32_t callback_ident;
	struct __attribute__((packed)) {
...
struct __attribute__((packed)) CB_COMPOUND4res {
	nfsstat4 status;
	utf8str_cs tag;
	struct __attribute__((packed)) {
		u_int resarray_len;
